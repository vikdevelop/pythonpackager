...
os.system('% s' % c1)
print("Running: install /usr/bin/..")
os.system('% s' % c2)
print("Running: install /usr/local/app/scripts/..")
os.system('% s' % c3)
print("Running: install /usr/share/applications/..")
os.system('% s' % c4)
print("Running: install /usr/share/icons/hicolor/128x128/apps/..")
